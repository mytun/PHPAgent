...
class PHPAgentOSX(NSObject):
    ...
    def setupUI(self):
        ...
        # Set initial image
        raw_data = base64.b64decode(''.join(PHPAGENT_ICON_DATA.strip().splitlines()))
        ...
        # Set a tooltip
        self.statusitem.setToolTip_(PHPAGENT_TITLE)
        ...
        self.console_window.setTitle_(PHPAGENT_TITLE)
...
def main():
    ...
    delegate = PHPAgentOSX.alloc().init()
